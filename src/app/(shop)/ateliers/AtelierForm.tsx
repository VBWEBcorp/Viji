...
/**
 * Réservation d'atelier (à domicile, etc.) avec paiement en ligne.
...
export default function AtelierForm({ productName, atelierSlug, price }: Props) {
  ...
  const sessionSlug = atelierSlug || "atelier-a-domicile";
  ...
  // Étape 2 → 3 : enregistre la réservation une fois le paiement confirmé.
    ...
    return (
      <div className="text-center py-10 px-6 bg-[var(--brand-cream)]/50 border border-[var(--brand-gold)]/20">
        ...
        <p className="text-[13px] text-gray-600 max-w-md mx-auto leading-relaxed">
          Votre atelier est réservé. Un reçu de paiement et les détails pratiques vous ont été envoyés par email.
        </p>
      </div>
    );
  }
